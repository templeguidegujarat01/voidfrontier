...
export class BotShip extends Ship {
     ...
     */
    think(enemies, allies, asteroids, dt) {
        if (!this.alive)
            return;
        ...
        if (this.state === 'fleeing' || this.state === 'retreating') {
            ...
            const damagedAlly = allies.find((a) => a.alive && a !== this && a.healthRatio() < LOW_HEALTH_RATIO && Vector2.distance(this.position, a.position) < ASSIST_RANGE);
            if (damagedAlly) {
