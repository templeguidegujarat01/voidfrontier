...
export const AVAILABLE_MODES: GameModeInfo[] = [
  {
    id: 'practice',
    name: 'Practice',
...
export const PLANNED_MODES: GameModeInfo[] = [
...
export interface MatchConfig {
  ...
  serverWsUrl?: string; // only for local-dev-multiplayer
...
export interface MatchResult {
  ...
  durationSec: number;
  won: boolean | null; // null when the mode has no win/loss condition
}
